...
- [JasonColapietro/suede-creator-skills](https://github.com/JasonColapietro/suede-creator-skills#readme) - Open-source skill pack for music creator workflows: rights, provenance, campaigns, SEO/AEO/AI EO, code grading, design QA, and agent commerce prep.
